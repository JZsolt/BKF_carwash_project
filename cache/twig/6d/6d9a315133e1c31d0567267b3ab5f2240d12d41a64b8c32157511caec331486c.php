...
/* contact.html.twig */
class __TwigTemplate_1f181cd7f1e019e14b1a9c6be6def4ba52cf0881e9da2487467b119d330f9cff extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
     ...
     ";
        // line 8
        $this->loadTemplate("partials/blog_sidebar_header.html.twig", "contact.html.twig", 8)->display($context);
        // line 9
      ...
      <div class=\"gdlr-item gdlr-blog-full \">
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "plugins", array()), "simple_form", array()), "enabled", array())) {
            // line 15
            echo "                ";
            $context["simple_form_config"] = (($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "header", array()), "simple_form", array())) ? ($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "header", array()), "simple_form", array())) : ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "themes", array()), "soraarticle", array()), "simple_form", array())));
            // line 16
            echo "                  ";
...
";
        // line 27
        $this->loadTemplate("partials/blog_sidebar_footer.html.twig", "contact.html.twig", 27)->display($context);
    }
    ...
    {
        return array (  81 => 4,  77 => 27,  66 => 19,  63 => 18,  57 => 16,  54 => 15,  52 => 14,  48 => 13,  42 => 9,  40 => 8,  35 => 5,  32 => 4,  29 => 3,  11 => 1,);
    }
        ...
        <div class=\"gdlr-ux gdlr-blog-full-ux\">
            <div class=\"blog-content-inner-wrapper contact\">
               ...
               {% if config.plugins.simple_form.enabled %}
                {% set simple_form_config = page.header.simple_form ?: config.themes.soraarticle.simple_form %}
...
{% endblock %}
", "contact.html.twig", "/Applications/AMPPS/www/grav/user/themes/soraarticle/templates/contact.html.twig");
    }
}
